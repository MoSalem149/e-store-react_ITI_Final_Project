...
import "../../style/Loogin/style.css"; // Corrected the typo in the import path
import "../../App.css";
...
function Login({ onLogin }) {
  ...
  const handleSignUp = () => {
    ...
    if (!isPhoneNumber(signUpPhoneNumber)) {
      setSignUpPhoneNumberValid(false);
      return;
    }
      ...
      >
        ...
        <p>
          {showSignUp
            ...
            : "Already have an account? You can Log in, else Please Sign Up First."}
        </p>
